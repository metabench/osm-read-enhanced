...
var zlib = require('./nodejs/zlib.js');
...
module.exports = {
    ...
    configureDecompressionWorkers: zlib.configureDecompressionWorkers,
    getWorkerPoolStats: zlib.getWorkerPoolStats,
    shutdownWorkerPool: zlib.shutdownWorkerPool
